...
namespace SportUnite.WEBUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ISportAttributeRepository, EFSportAttributeRepository>();
            services.AddTransient<ISportComplexRepository, EFSportComplexRepository>();
            services.AddTransient<ISportEventRepository, EFSportEventRepository>();
            services.AddTransient<ISportHallRepository, EFSportHallRepository>();
            services.AddTransient<IInvoiceRepository, EFInvoiceRepository>();
            services.AddTransient<ISportSportAttributeRepository, EFSportSportAttributeRepository>();*/
